...
namespace ProjectOneMore
{
    public static class GameConfig
    {
        ...
        public static readonly float BATTLE_HIGHEST_AUTO_ATTACK_SPEED = 0.1f;
        public static readonly float BATTLE_BASE_MOVE_SPEED_MULTIPLIER = 3f;
        ...
        public static readonly int MAIN_CAMERA_PRIORITY = 20;
        public static readonly int SKILL_TARGETING_CAMERA_PRIORITY = 21;
    }
}