...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        //--- My Custom
        private PlayerInput _focusedPlayerInput;
        ...
        public bool ResolveActionAndBinding(out InputAction action, out int bindingIndex)
        {
            ...
            action = _focusedPlayerInput?.actions.FindAction(m_Action.name);
            if (action == null)
                return false;
        ...
        public void UpdateBindingDisplay()
        {
            ...
            var action = _focusedPlayerInput?.actions.FindAction(m_Action.name);
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            void CleanUp()
            {
                ...
                //--- My custom for enable action after rebind
                action.Enable();
            }

            //--- My custom for disable before rebind
            action.Disable();
